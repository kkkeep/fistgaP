...
public class Logger {
    ...
    private static String PRIVATE_TAG = "Manhua";
    private static String PUBLIC_TAG = "Easou_Manhua";
    ...
    private static String getSimpleStackTrace(){
        ...
        return  String.format(Locale.getDefault(),SIMPLE_PREFIX,targetElement.getFileName(),targetElement.getLineNumber(),traceElement.getMethodName());
